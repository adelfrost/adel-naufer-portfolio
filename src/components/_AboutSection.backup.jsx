...
export default function AboutSection() {
  return (
    ...
    >
      {/* Portrait — desktop: large cutout spanning the WHOLE section, behind the
          content & panels (z-0). object-top keeps head→hip prominent up top while
          the lower body runs down behind the THE JOURNEY / RIGHT NOW panels. */}
      <div className="hidden md:block pointer-events-none select-none absolute inset-0 z-0">
        <div className="relative mx-auto h-full max-w-[1536px] px-5 sm:px-8 md:px-10">
          <img
            src={ABOUT.portrait}
            alt="Adel Naufer"
            draggable={false}
            className="absolute right-0 top-0 h-[112%] w-[46%] lg:w-[44%] object-cover object-top"
      ...
      {/* ───────── SO FAR ───────── */}
      <div className="relative z-10 mx-auto max-w-[1536px] px-5 sm:px-8 md:px-10 pb-28 md:pb-36">
